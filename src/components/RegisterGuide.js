    ...
    render() {
        return (
            <div>
                ...
                2. กรอกข้อมูลในแบบฟอร์ม (เอกสาร) ลงทะเบียนเข้าใช้งานระบบสารสนเทศ เพื่อเป็นการยืนยันว่าเป็นบุคลากรในหน่วยงานสาธารณสุข (ลงนามรับรองด้วยหัวหน้าหน่วยงานหรือผู้บังคับบัญชา) Download แบบฟอร์มได้ที่ <a href="https://r8way.moph.go.th/r8way/view_publicize.php?id=1642" rel="noreferrer" target="_blank">Click ที่นี่</a><br/>
