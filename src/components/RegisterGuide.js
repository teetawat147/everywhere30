    ...
    render() {
        return (
            <div>
                ...
                1. ลงทะเบียนผู้ใช้งานในเว็บไซต์ R8anywhere ได้ที่ <a href="/register">https://cloud1.r8way.moph.go.th/r8anywhere/register</a> (สามารถลงทะเบียนด้วย Line account ได้)<br/>
