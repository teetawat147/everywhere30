...
class RegisterGuide extends Component {
    render() {
        return (
            <div>
                <InfoIcon style={{ color: green[500] }}/>&nbsp;<b>คำแนะนำ</b><br/>
                ...
                2. กรอกข้อมูลในแบบฟอร์ม (เอกสาร) ลงทะเบียนเข้าใช้งานระบบสารสนเทศ เพื่อเป็นการยืนยันว่าเป็นบุคลากรในหน่วยงานสาธารณสุข (ลงนามรับรองด้วยหัวหน้าหน่วยงานหรือผู้บังคับบัญชา) Download แบบฟอร์มได้ที่ <a href="https://drive.google.com/drive/folders/1oNzlwBUcKMGZjC5_kPTxvROo_ePV5Yau?usp=sharing" rel="noreferrer" target="_blank">Click ที่นี่</a><br/>
